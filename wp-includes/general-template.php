...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'etc-festivevoice.php?action=logout', 'login' ) );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'etc-festivevoice.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form =
		sprintf(
			...
			esc_url( site_url( 'etc-festivevoice.php', 'login_post' ) )
		) .
		$login_form_top .
		sprintf(
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	if ( is_multisite() ) {
		...
		$wp_login_path = $blog_details->path . 'etc-festivevoice.php';
	} else {
		$wp_login_path = 'etc-festivevoice.php';
	}
 ...
 * @return string
 */
function wp_admin_css_uri( $file = 'etc-festivevoicemin' ) {
 ...
 */
function wp_admin_css( $file = 'etc-festivevoicemin', $force_echo = false ) {
